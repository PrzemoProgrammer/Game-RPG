...
export default class Window {
    constructor(scene, config) {
        ...
        this.grabWindowTarget = this.scene.add.rectangle(this.windowSprite.x, this.windowSprite.y, this.windowSprite.displayWidth, this.windowSprite.displayHeight, 0xff66ff).setVisible(false)
        ...
        this.windowContainer = this.scene.add.container(this.scene.game.canvas.clientWidth/2 - this.windowSprite.displayWidth/2, this.scene.game.canvas.clientHeight/2 -this.windowSprite.displayHeight/2, [this.windowSprite, this.grabWindowTarget, this.name, this.escapeButton])
        if(config.position){
    ...
    moveable(){
        this.windowContainer.setSize(this.grabWindowTarget.width, this.grabWindowTarget.height);
